            ...
            <Grid>
                <Row className="show-grid">
                    <Col xs={12} sm={4} lg={4} md={4} className="marketingItem">
                        ...
                        <a href="https://fafsa.ed.gov/" target="_blank" rel="noopener noreferrer" className="btn btn-primary" > More Information &raquo;</a>
                    </Col>
                    <Col xs={12} sm={4} lg={4} md={4} className="marketingItem">
                        ...
                        <a href="https://www.bestcollegereviews.org/features/most-beautiful-college-campuses/" rel="noopener noreferrer" target="_blank" className="btn btn-primary" > More Information &raquo;</a>
                    </Col>
                    <Col xs={12} sm={4} lg={4} md={4} className="marketingItem">
                        ...
                        <a href="https://www.usnews.com/education/best-colleges/slideshows/10-things-to-know-about-college-early-admissions-programs " rel="noopener noreferrer" target="_blank" className="btn btn-primary" > More Information &raquo;</a>
